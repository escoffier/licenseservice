...
public class AuthClientConfig {
    ...
    @Value("${oauth.resource:http://192.168.21.120:8091}")
    private String baseUrl;
    @Value("${oauth.authorize:http://192.168.21.120:8091/oauth/authorize}")
    private String authorizeUrl;
    @Value("${oauth.token:http://192.168.21.120:8091/oauth/token}")
